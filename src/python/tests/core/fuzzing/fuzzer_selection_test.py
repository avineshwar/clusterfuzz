...
def _mock_random_weighted_choice(
    items, weight_attribute="weight"
...
class GetFuzzTaskPayloadTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        test_helpers.patch(self, ["base.utils.random_weighted_choice",])
    ...
    def test_platform_restriction(self, local_development):
        ...
        data_types.FuzzerJobs(platform="windows", fuzzer_jobs=[windows_mapping]).put()
...
class UpdatePlatformForJobTest(unittest.TestCase):
    ...
    def test_jobs_updated(self):
        ...
        platforms = [
            job.platform for job in ndb_utils.get_all_from_model(data_types.FuzzerJob)
        ]
...
class GetFuzzTargetWeightsTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        data_types.FuzzTarget(engine="engine", project="proj", binary="child_0",).put()
        ...
        data_types.FuzzTarget(engine="engine", project="proj", binary="child_1",).put()
        data_types.FuzzTargetJob(
        ...
        data_types.FuzzTarget(
            engine="different_fuzzer", binary="child_2", project="test-project",
        ).put()
        data_types.FuzzTargetJob(
