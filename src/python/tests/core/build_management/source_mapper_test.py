...
class GetComponentSourceAndRelativePathTest(unittest.TestCase):
    ...
    def test_get_component_source_and_relative_path_chromium(self):
        ...
        self.assertEqual(
            ...
            source_mapper.ComponentPath("/src", "content/common.h", "content/common.h"),
        )
        self.assertEqual(
            source_mapper.get_component_source_and_relative_path(
                r"content\common.h", revisions_dict
        ...
        self.assertEqual(
            ...
            source_mapper.ComponentPath(
                "/src", "v8_overrides/init.cc", "v8_overrides/init.cc"
            ),
        )
        self.assertEqual(
            source_mapper.get_component_source_and_relative_path(
    ...
    def test_get_component_source_and_relative_path_oss_fuzz(self):
        ...
        self.assertEqual(
            ...
            source_mapper.ComponentPath(
                "/src/libass", "test/test.c", "libass/test/test.c"
            ),
        )
        self.assertEqual(
            source_mapper.get_component_source_and_relative_path(
            ...
            source_mapper.ComponentPath(
                "/src/fribidi", "lib/common.h", "fribidi/lib/common.h"
            ),
        )
        self.assertEqual(
            source_mapper.get_component_source_and_relative_path(
...
class NormalizeSourcePathTest(unittest.TestCase):
    ...
    def test_normalize_source_path(self):
        ...
        self.assertEqual(
            source_mapper.normalize_source_path("heap/compact.cc"), "heap/compact.cc"
        )
        self.assertEqual(
...
class VCSViewerTest(unittest.TestCase):
    ...
    def test_google_vcs(self):
        ...
        self.assertEqual(
            "https://cs.corp.google.com/dir1/dir2/?rcl=1337",
            vcs.get_source_url_for_revision(1337),
        )
        self.assertEqual(None, vcs.get_source_url_for_revision_diff(1337, 1338))
        self.assertEqual(
            "https://cs.corp.google.com" "/dir1/dir2/dir3/dir4/file1.txt?rcl=1337&l=10",
