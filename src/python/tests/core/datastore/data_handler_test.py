...
class DataHandlerTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        environment.set_value(
            'FUZZ_DATA', '/tmp/inputs/fuzzer-common-data-bundles')
    ...
    def test_get_issue_summary_empty(self):
        ...
        self.assertEqual(
            summary, 'project: Unknown error with empty stacktrace')
    ...
    def test_get_from_job(self):
        ...
        data_types.Job(
            ...
            environment_string=('ISSUE_TRACKER = from_job\n'
                                'HELP_URL = help_url\n')).put()
        self.assertEqual(
            'from_job', data_handler.get_issue_tracker_name('job'))
...
class UpdateTestcaseCommentTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock.current_date_time.return_value = datetime.datetime(
            2019, 1, 1)
