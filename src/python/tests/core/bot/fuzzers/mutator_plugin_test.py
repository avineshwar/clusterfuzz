...
class FindMutatorPluginTest(fake_filesystem_unittest.TestCase):
    ...
    def test_find_mutator_plugin_with_usable(self):
        ...
        self.assertEqual(usable_plugin_path,
                         mutator_plugin.find_mutator_plugin())
...
class PluginGetterTest(fake_filesystem_unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.plugin_getter = mutator_plugin.PluginGetter(
            self.fuzzer_binary_name)
        self.plugins_archives_dir = os.path.join(
            self.plugins_root_dir, 'archives')
    ...
    def test_create_directories(self):
        ...
        self.assertTrue(all(os.path.isdir(directory)
