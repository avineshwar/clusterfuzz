...
def mock_get_iam_policy(bucket=None):
    ...
    if bucket in (
        "lib1-logs.clusterfuzz-external.appspot.com",
...
class GenericProjectSetupTest(unittest.TestCase):
                ...
                "project_setup": [
                    ...
                    },
                    {
                        ...
                        "additional_vars": {
                            ...
                            "libfuzzer": {
                                "address": {"ASAN_VAR": "VAL-dbg",},
                                "memory": {"NOT_SET": "VAL-dbg",},
                            },
                        },
                    },
                ],
    ...
    def test_execute(self):
        ...
        job = data_types.Job.query(
            data_types.Job.name == "libfuzzer_asan_a-b_dbg"
        ).get()
        self.assertEqual(
            "FUZZ_TARGET_BUILD_BUCKET_PATH = "
        ...
        job = data_types.Job.query(
            data_types.Job.name == "honggfuzz_asan_a-b_dbg"
        ).get()
        self.assertEqual(
            "FUZZ_TARGET_BUILD_BUCKET_PATH = "
        ...
        six.assertCountEqual(
            self,
            ["libfuzzer_asan_a-b", "libfuzzer_asan_a-b_dbg", "old_unmanaged",],
            libfuzzer.jobs,
        )
        ...
        six.assertCountEqual(
            self, ["honggfuzz_asan_a-b", "honggfuzz_asan_a-b_dbg",], honggfuzz.jobs
        )
